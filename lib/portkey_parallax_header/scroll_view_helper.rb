class UIScrollView
  ...
  def add_portkey_parallax_with_view(view, height: height)
    add_portkey_parallax_with_view(view, height: height, shadow: false, min_height: 0)
  end

  # @param [UIView] view, the view being added
  # @param [Float] height, the height of the parallax header
  # @param [Boolean] shadow, whether to show a shadow along the bottom or not
  def add_portkey_parallax_with_view(view, height: height, shadow: shadow)
    add_portkey_parallax_with_view(view, height: height, shadow: shadow, min_height: 0)
  end
  ...
  # @param [Boolean] shadow, whether to show a shadow along the bottom or not
  def add_portkey_parallax_with_view(view, height: height, shadow: shadow, min_height: min_height)
